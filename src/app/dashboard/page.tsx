      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              This is a protected area. You have been successfully authenticated.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p>You can start building your application features here. This content is only visible to logged-in users.</p>
          </CardContent>
        </Card>
           ...
           <CardFooter>
            <Button asChild className="w-full">
                <Link href="/dashboard/vps">
                    Manage VPS <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
            </Button>
          </CardFooter>
        </Card>
