...
export function NetworkingPage() {
  ...
  const fetchNetworks = async () => {
    try {
      ...
      console.error('Failed to fetch private networks:', err);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="p-8 animate-fade-in">
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="font-bangla text-[var(--primary)] font-bold text-sm">প্রাইভেট নেটওয়ার্কিং — আপনার আইসোলেটেড নেটওয়ার্ক পরিচালনা করুন।</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
         <div className="lg:col-span-2 card p-8 border border-[var(--border)] bg-[var(--surface-2)] flex flex-col md:flex-row items-center gap-10">
            <div className="w-full md:w-1/2">
               ...
               <p className="text-sm text-[var(--text-muted)] leading-relaxed mb-6">
                  Private Networking (VPC) allows your servers to communicate over a dedicated, isolated L2 network. This traffic never touches the public internet, ensuring maximum security and sub-millisecond latency between your nodes.
               </p>
            ...
            <div className="w-full md:w-1/2 flex justify-center">
               <svg width="240" height="240" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_30px_rgba(var(--primary-rgb),0.3)]">
                  <rect x="20" y="20" width="200" height="200" rx="40" stroke="var(--primary)" strokeWidth="2" strokeDasharray="8 8" className="animate-[spin_60s_linear_infinite]" />
         ...
         <div className="card p-8 border border-[var(--primary-transparent-border)] bg-[var(--primary-transparent)] flex flex-col justify-center">
            ...
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">
               All Cloud VPS and VDS instances support VPC attachment. Storage VPS products are currently excluded from private network mesh.
            </p>
         </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="card p-20 text-center border-2 border-dashed border-[var(--border)] bg-transparent">
           ...
           <p className="text-[var(--text-muted)] max-w-sm mx-auto mb-8">Deploy an isolated private network to enable secure communication between your compute nodes.</p>
           <button className="btn btn-primary">Create Network</button>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {networks.map(n => (
            <div key={n.privateNetworkId} className="card p-8 border border-[var(--border)] hover:border-[var(--primary-transparent-border)] transition-all group overflow-hidden relative">
               ...
               <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-8 mb-10">
                     <div className="p-5 rounded-2xl bg-[var(--surface-2)] border border-[var(--border)]">
                        ...
                        <div className="text-2xl font-black text-[var(--primary)]">{n.instanceIds.length}</div>
                     </div>
                     <div className="p-5 rounded-2xl bg-[var(--surface-2)] border border-[var(--border)]">
                  ...
                  <div className="flex items-center gap-4">
                     <button className="btn btn-primary flex-1">Assign Nodes</button>
