...
DJOSER = {
    ...
    'SEND_ACTIVATION_EMAIL': False,  # Disabled: using signal handlers instead with proper error handling
...
# Email Configuration
# Allow overriding email backend via environment for local testing (default: SMTP)
...
# OAuth callback path on frontend for token exchange completion
FRONTEND_OAUTH_CALLBACK_PATH = os.environ.get('FRONTEND_OAUTH_CALLBACK_PATH', '/oauth/callback/')
